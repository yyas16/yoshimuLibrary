...
% Br@B in radial direction, nT
% Bt@B in theta direction, nT
% Bp@B in phi direction, nT
% 
% modified by y. yoshimura, 20150714
% verified by comparing with 
% http://www.geomag.bgs.ac.uk/data_service/models_compass/igrf.html
...
theta = (90 - theta) * pi / 180; % coelevation
phi   = phi * pi / 180;

a = 6371.2;  % Reference radius used in IGRF, km
