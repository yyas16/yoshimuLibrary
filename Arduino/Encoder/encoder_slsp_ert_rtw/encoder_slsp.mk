###########################################################################
## Makefile generated for Simulink model 'encoder_slsp'. 
## 
## Makefile     : encoder_slsp.mk
## Generated on : Fri Nov 27 10:57:20 2015
## MATLAB Coder version: 3.0 (R2015b)
## 
## Build Info:
## 
## Final product: $(RELATIVE_PATH_TO_ANCHOR)/encoder_slsp.elf
...
MASTER_ANCHOR_DIR         = 
START_DIR                 = /Users/yyas16/Dropbox/MATLAB/yoshimuLibrary/Arduino/Encoder
ARCH                      = maci64
SOLVER                    = 
SOLVER_OBJ                = 
CLASSIC_INTERFACE         = 0
TGT_FCN_LIB               = None
MODELREF_LINK_RSPFILE_NAME = encoder_slsp_ref.rsp
...
PRODUCT = $(RELATIVE_PATH_TO_ANCHOR)/encoder_slsp.elf
...
INCLUDES_BUILDINFO = -I$(START_DIR)/encoder_slsp_ert_rtw -I$(START_DIR) -I/Users/yyas16/Dropbox/MATLAB/References/DriversGuide -I$(MATLAB_ROOT)/extern/include -I$(MATLAB_ROOT)/simulink/include -I$(MATLAB_ROOT)/rtw/c/src -I$(MATLAB_ROOT)/rtw/c/src/ext_mode/common -I$(MATLAB_ROOT)/rtw/c/ert -I$(MATLAB_ROOT)/toolbox/coder/rtiostream/src/utils -I$(ARDUINO_ROOT)/hardware/arduino/avr/cores/arduino -I$(ARDUINO_ROOT)/hardware/arduino/avr/variants/mega -I/Users/yyas16/Documents/MATLAB/SupportPackages/R2015b/arduino/toolbox/target/supportpackages/arduinotarget/registry/../include -I/Users/yyas16/Documents/MATLAB/SupportPackages/R2015b/arduino/toolbox/target/supportpackages/arduinotarget/registry/../scheduler/include -I/Users/yyas16/Documents/MATLAB/SupportPackages/R2015b/arduinobase/toolbox/target/supportpackages/arduinobase/include
...
DEFINES_STANDARD = -DMODEL=encoder_slsp -DNUMST=1 -DNCSTATES=0 -DHAVESTDIO -DUNIX
...
%.o : $(START_DIR)/encoder_slsp_ert_rtw/%.c
	$(CC) $(CFLAGS) -o "$@" "$<"


%.o : $(START_DIR)/encoder_slsp_ert_rtw/%.s
	$(AS) $(ASFLAGS)  "$@" "$<"


%.o : $(START_DIR)/encoder_slsp_ert_rtw/%.cpp
	$(CPP) $(CPPFLAGS) -o "$@" "$<"
...
MW_ArduinoHWInit.o : /Users/yyas16/Documents/MATLAB/SupportPackages/R2015b/arduino/toolbox/target/supportpackages/arduinotarget/registry/../src/MW_ArduinoHWInit.cpp
	$(CPP) $(CPPFLAGS) -o "$@" "$<"


io_wrappers.o : /Users/yyas16/Documents/MATLAB/SupportPackages/R2015b/arduinobase/toolbox/target/supportpackages/arduinobase/src/io_wrappers.cpp
	$(CPP) $(CPPFLAGS) -o "$@" "$<"


arduinoAVRScheduler.o : /Users/yyas16/Documents/MATLAB/SupportPackages/R2015b/arduino/toolbox/target/supportpackages/arduinotarget/registry/../scheduler/src/arduinoAVRScheduler.cpp
	$(CPP) $(CPPFLAGS) -o "$@" "$<"
...
rtiostream_serial.o : /Users/yyas16/Documents/MATLAB/SupportPackages/R2015b/arduino/toolbox/target/supportpackages/arduinotarget/registry/../src/rtiostream_serial.cpp
	$(CPP) $(CPPFLAGS) -o "$@" "$<"
