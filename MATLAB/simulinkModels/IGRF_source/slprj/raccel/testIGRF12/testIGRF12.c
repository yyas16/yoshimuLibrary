...
"slprj//raccel//testIGRF12//testIGRF12_Jpattern.mat" ; const int_T
...
const real_T testIGRF12_RGND = 0.0 ; B rtB ; DW rtDW ; static SimStruct
model_S ; SimStruct * const rtS = & model_S ; void MdlStart ( void ) { { void
...
externalInputIsInDatasetFormat ) { } } { int_T dimensions [ 2 ] = { 3 , 1 } ;
rtDW . aehjs4tnmp . LoggedData = rt_CreateLogVar ( ssGetRTWLogInfo ( rtS ) ,
ssGetTStart ( rtS ) , ssGetTFinal ( rtS ) , 0.0 , ( & ssGetErrorStatus ( rtS
) ) , "simout" , SS_DOUBLE , 0 , 0 , 0 , 3 , 2 , dimensions , NO_LOGVALDIMS ,
( NULL ) , ( NULL ) , 0 , 1 , 0.0 , 1 ) ; if ( rtDW . aehjs4tnmp . LoggedData
== ( NULL ) ) return ; } } void MdlOutputs ( int_T tid ) { if ( ssIsSampleHit
( rtS , 0 , 0 ) ) { if ( ssGetLogOutput ( rtS ) ) { { double locTime =
ssGetTaskTime ( rtS , 0 ) ; ; if ( rtwTimeInLoggingInterval (
rtliGetLoggingInterval ( ssGetRootSS ( rtS ) -> mdlInfo -> rtwLogInfo ) ,
locTime ) ) { rt_UpdateLogVar ( ( LogVar * ) ( LogVar * ) ( rtDW . aehjs4tnmp
. LoggedData ) , & rtB . lntw1t3wio [ 0 ] , 0 ) ; } } } } UNUSED_PARAMETER (
tid ) ; } void MdlOutputsTID1 ( int_T tid ) { sfunc_igrf12_Outputs_wrapper (
& rtP . Constant_Value , & rtP . Constant1_Value , & rtP . Constant2_Value ,
& rtP . Constant3_Value , & rtB . lntw1t3wio [ 0 ] ) ;
sfunc_igrf12_Outputs_wrapper ( ( real_T * ) & testIGRF12_RGND , ( real_T * )
& testIGRF12_RGND , ( real_T * ) & testIGRF12_RGND , ( real_T * ) &
testIGRF12_RGND , & rtB . aun4gqhlc5 [ 0 ] ) ; UNUSED_PARAMETER ( tid ) ; }
...
ssSetNumSampleTimes ( rtS , 1 ) ; ssSetNumBlocks ( rtS , 7 ) ;
ssSetNumBlockIO ( rtS , 2 ) ; ssSetNumBlockParams ( rtS , 4 ) ; } void
MdlInitializeSampleTimes ( void ) { ssSetSampleTime ( rtS , 0 , 0.0 ) ;
ssSetOffsetTime ( rtS , 0 , 1.0 ) ; } void raccel_set_checksum ( ) {
ssSetChecksumVal ( rtS , 0 , 2013793848U ) ; ssSetChecksumVal ( rtS , 1 ,
2568148352U ) ; ssSetChecksumVal ( rtS , 2 , 1217162368U ) ; ssSetChecksumVal
( rtS , 3 , 3041486126U ) ; }
#if defined(_MSC_VER)
#pragma optimize( "", off )
#endif
...
rtPTransTable ; } testIGRF12_InitializeDataMapInfo ( ) ;
ssSetIsRapidAcceleratorActive ( rtS , true ) ; ssSetRootSS ( rtS , rtS ) ;
ssSetVersion ( rtS , SIMSTRUCT_VERSION_LEVEL2 ) ; ssSetModelName ( rtS ,
"testIGRF12" ) ; ssSetPath ( rtS , "testIGRF12" ) ; ssSetTStart ( rtS , 0.0 )
...
2013793848U ) ; ssSetChecksumVal ( rtS , 1 , 2568148352U ) ; ssSetChecksumVal
( rtS , 2 , 1217162368U ) ; ssSetChecksumVal ( rtS , 3 , 3041486126U ) ; {
