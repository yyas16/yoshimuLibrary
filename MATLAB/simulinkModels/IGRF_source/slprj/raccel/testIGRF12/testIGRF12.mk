...
MODEL                  = testIGRF12
MODULES                = rt_logging.c rtGetInf.c rtGetNaN.c rt_nonfinite.c testIGRF12.c testIGRF12_capi.c testIGRF12_data.c testIGRF12_tgtconn.c rt_logging_mmi.c rtw_modelmap_utils.c raccel_main_new.c raccel_sup.c raccel_mat.c simulink_solver_api.c raccel_utils.c common_utils.c ext_svr.c updown.c ext_work.c rtiostream_interface.c rtiostream_tcpip.c
MAKEFILE               = testIGRF12.mk
...
MASTER_ANCHOR_DIR      = 
START_DIR              = /Users/yyas16/Dropbox/MATLAB/lightCurves/ATOM_LC/simlinkModel/IGRF
S_FUNCTIONS            = rtiostream_utils.c igrfsyn12.c sfunc_igrf12_wrapper.c
...
ADD_INCLUDES = \
	-I$(START_DIR) \
	-I$(START_DIR)/slprj/raccel/testIGRF12 \
