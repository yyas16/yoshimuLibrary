 ...
 *  ------------------------------------------------------------------------- 
 *
 * Created: Fri Mar 01 14:13:53 2019
 */

#define S_FUNCTION_LEVEL 2
#define S_FUNCTION_NAME sfunc_igrf12
/*<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<*/
/* %%%-SFUNWIZ_defines_Changes_BEGIN --- EDIT HERE TO _END */
#define NUM_INPUTS            4
/* Input Port  0 */
#define IN_PORT_0_NAME        fyear
...
#define SOURCEFILES           "__SFB__igrfsyn12.c"
#define PANELINDEX            8
...
extern void sfunc_igrf12_Outputs_wrapper(const real_T *fyear,
			const real_T *elon,
			const real_T *nlat,
			const real_T *alt,
			real_T *b_out);
...
{
    const real_T *fyear = (real_T *) ssGetInputPortRealSignal(S, 0);
    const real_T *elon = (real_T *) ssGetInputPortRealSignal(S, 1);
    const real_T *nlat = (real_T *) ssGetInputPortRealSignal(S, 2);
    const real_T *alt = (real_T *) ssGetInputPortRealSignal(S, 3);
    real_T *b_out = (real_T *) ssGetOutputPortRealSignal(S, 0);

    sfunc_igrf12_Outputs_wrapper(fyear, elon, nlat, alt, b_out);
