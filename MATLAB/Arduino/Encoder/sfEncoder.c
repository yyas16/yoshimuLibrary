 ...
 *
  ...
  *  ------------------------------------------------------------------------- 
* Created: Fri Nov 27 12:28:47 2015
*/
#define S_FUNCTION_LEVEL 2
#define S_FUNCTION_NAME sfEncoder
/*<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<*/
...
#define NPARAMS              2
/* Parameter  1 */
#define PARAMETER_0_NAME      pinA
#define PARAMETER_0_DTYPE     uint8_T
#define PARAMETER_0_COMPLEX   COMPLEX_NO
/* Parameter  2 */
#define PARAMETER_1_NAME      pinB
...
{
    int32_T        *counts  = (int32_T *)ssGetOutputPortRealSignal(S,0);
    const real_T   *xD = ssGetDiscStates(S);
    const int_T   p_width0  = mxGetNumberOfElements(PARAM_DEF0(S));
    const int_T   p_width1  = mxGetNumberOfElements(PARAM_DEF1(S));
    const uint8_T  *pinA  = (const uint8_T *)mxGetData(PARAM_DEF0(S));
    const uint8_T  *pinB  = (const uint8_T *)mxGetData(PARAM_DEF1(S));

    sfEncoder_Outputs_wrapper(counts, xD, pinA, p_width0, pinB, p_width1);
...
/* Function: mdlUpdate ======================================================
  ...
  static void mdlUpdate(SimStruct *S, int_T tid)
  {
    ...
    sfEncoder_Update_wrapper(counts,  xD, pinA, p_width0, pinB, p_width1);
}
