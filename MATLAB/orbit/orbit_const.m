...
const.AU_km = 149597870.691; % 1 AU, km
const.AU_m = 149597870.691 * 10^3; % 1 AU, m
...
const.GM_m = const.GM * 10^3 * 10^3 * 10^3;     % m^3/s^2
const.GM_day = 36599213352960.0;     % km^3/day^2
